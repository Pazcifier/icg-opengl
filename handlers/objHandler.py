...
class ObjHandler(object):
    ...
    def __save(self):
        ...
        self.__loaded.update({ self.__name: {"numVertex": self.__numVertx, "numFaces": self.__numFaces, "Arrays": self.__arrays, "Elements": self.__elements, "ArrayElements": self.__arrayElements} })
        self.__reset()
